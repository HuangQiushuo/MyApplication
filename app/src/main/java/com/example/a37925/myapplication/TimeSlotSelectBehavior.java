 ...
 * a bottom sheet.
 */
public class TimeSlotSelectBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
     ...
     */
    public TimeSlotSelectBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public boolean onLayoutChild(CoordinatorLayout parent, V child, int layoutDirection) {
        ...
        bottomOffset = ((ViewGroup.MarginLayoutParams)child.getLayoutParams()).bottomMargin;
        ...
        mMinOffset = Math.max(0, mParentHeight - childHeight)-bottomOffset;
    ...
    public void onNestedPreScroll(CoordinatorLayout coordinatorLayout, V child, View target, int dx,
        ...
        dispatchOnSlide(child.getTop(), -consumed[1]);
    ...
    void dispatchOnSlide(int top, int y) {
        View bottomSheet = mViewRef.get();
        if (bottomSheet != null && mCallback != null) {
//            if (top >= mMaxOffset) {
//                mCallback.onSlide(bottomSheet, y);
//            }else{
//                if(y < 0&&top<=(mMaxOffset-bottomOffset)){
//                    mCallback.onSlide(bottomSheet, y);
//                }
//            }
            mCallback.onSlide(bottomSheet,y);
    ...
    public static <V extends View> TimeSlotSelectBehavior<V> from(V view) {
        ...
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
                .getBehavior();
        if (!(behavior instanceof TimeSlotSelectBehavior)) {
            throw new IllegalArgumentException(
                    "The view is not associated with BottomSheetBehavior");
        }
        return (TimeSlotSelectBehavior<V>) behavior;
    }
